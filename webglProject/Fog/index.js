...
function main() {
    ...
    let modelMatrix = new Matrix4().setTranslate(25.0, 62.0, 34.0).scale(10.0).rotate(angle, 1.0, 0.0, 0.0);
    ...
    document.onkeydown = function (event) {
        ...
        modelMatrix.setTranslate(25.0, 62.0, 34.0).rotate(angle, 1.0, 0.0, 0.0);
        let tempMatrix = new Matrix4().set(mvpMatrix);
        tempMatrix.multiply(modelMatrix);
