...
window.onload = main;
const vertexShaderFile = 'D:\\GitStone\\WebGL\\webglFundament_BufferInfo\\glsl\\vertexShader.glsl';
const fragmentShaderFile = 'D:\\GitStone\\WebGL\\webglFundament_BufferInfo\\glsl\\fragmentShader.glsl';
...
function initScene (obj) {
    ...
    let buffers = Data.createSphereBuffers(gl, 10, 48, 24);
